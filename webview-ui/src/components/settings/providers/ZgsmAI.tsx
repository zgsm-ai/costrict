...
export const ZgsmAI = ({ apiConfiguration, setApiConfigurationField }: OpenAICompatibleProps) => {
	...
	return (
		<>
			...
			<VSCodeTextField
				...
				className="w-full">
				<label className="block font-medium mb-1">{t("settings:providers.zgsmApiKey")}</label>
			</VSCodeTextField>
			<ModelPicker
