...
1. Analyze the user's message: if it is a simple question or conversational message that can be answered directly, use \`attempt_completion\` tool immediately with your answer as the result. Otherwise, set clear, achievable goals for the task and prioritize them.
