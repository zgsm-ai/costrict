...
1. Analyze the user's message: for simple questions, respond via \`attempt_completion\` tool immediately. Otherwise, set clear, prioritized goals.
...
4. On completion, use \`attempt_completion\` tool to present the result. The user may provide feedback for improvements.`
}
