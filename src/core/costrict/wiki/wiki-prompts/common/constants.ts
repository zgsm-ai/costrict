...
export const NEW_SUBTASK = `Create the following \`subtask\` subtask, execute it, and populate the Input and Background information based on the actual situation:`
...
export const COMMON_RULES = `1. Use \`todo_list\` to plan tasks, execute them one by one.
