...
**项目定位**: {从项目概览文档提取的项目定位，50字以内}
**技术栈**: {从项目概览文档提取的技术栈，50字以内}
**架构特点**: {从项目概览文档提取的架构特点，50字以内}
...
| 文档名称 | 文件路径 | 主要内容 | 适用场景 |
|---------|---------|---------|---------|
| **{文档名}** | [{相对项目根目录的路径}] | {文档摘要，30字以内} | {场景关键词，比如项目理解、技术选型、功能开发} |
| **{文档名}** | [{相对项目根目录的路径}] | {文档摘要，30字以内} | {场景关键词，比如架构设计、模块开发、系统集成} |
\`\`\`\`
