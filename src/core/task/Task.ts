...
export class Task extends EventEmitter<ClineEvents> {
	...
	async ask(
		...
		if (this.abort) {
			throw new Error(`[Shenme#ask] task ${this.taskId}.${this.instanceId} aborted`)
		}
	...
	async say(
		...
		if (this.abort) {
			throw new Error(`[Shenme#say] task ${this.taskId}.${this.instanceId} aborted`)
		}
	...
	public async recursivelyMakeClineRequests(
		...
		if (this.abort) {
			throw new Error(`[Shenme#recursivelyMakeRooRequests] task ${this.taskId}.${this.instanceId} aborted`)
		}
