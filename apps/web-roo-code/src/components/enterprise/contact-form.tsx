...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping Costrict's enterprise solution."
			: "Fill out the form below to see Costrict's enterprise capabilities in action."
