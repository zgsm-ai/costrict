...
- Update environment variables: ZGMSM** prefixes migrated to COSTRICT** (with backward compatibility)
...
- Sync roocode [last commit](https://github.com/zgsm-ai/costrict/commit/a8a44510d5e3d92626e987d01793c1cbc82ceab2)
- Fix known issues
